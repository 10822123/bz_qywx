module.exports.list = [
  {
    ...
    children: [
      ...
      {
        path: 'router_api_list',
        name: 'ApiRouterList',
        component: '@/views/router_api/lists',
        meta: {
          title: 'API管理',
          icon: 'home-2-line',
          noClosable: true,
      ...
      {
        path: 'router_api_group',
        name: 'ApiRouterGroupList',
        component: '@/views/router_api_group/lists',
        meta: {
          title: 'API分组',
          icon: 'home-2-line',
          noClosable: true,
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: '@/views/tools/SpeechSynthesis',
          meta: {
            title: '语音合成',
