...
// 示例用法
const inputList = [
  { id: 169, parent_id: 159, name: 'd', info: 'AS' },
  { id: 167, parent_id: 0, name: 'rff', info: '3333bk.' },
  { id: 166, parent_id: 0, name: 'user', info: '用户管理' },
  { id: 159, parent_id: 0, name: 'usersssfdf', info: '用户管理c555' }
];

const tree = listToTree(inputList, { idProperty: 'id', parentProperty: 'parent_id', childrenProperty: 'children' });
