...
router.get('/router/getList',require('../controllers/routerv').router_list)

router.get('/router/get_list',require('../controllers/routerv').get_list)
router.get('/router/get_list_tree',require('../controllers/routerv').get_list_tree)
router.post('/router/do_edit', require('../schema/router').vedit, require('../controllers/routerv').do_edit)
router.post('/router/do_delete', require('../schema/router').vdel, require('../controllers/routerv').do_delete)
