const { sequelize,Sequelize,Op , DataTypes } = require('../utils/sequelize')

// 定义数据表模型  
const router_bind_api = sequelize.define('router_bind_api', {
  id: { 
...
module.exports = { router_bind_api,Op ,sequelize,Sequelize,validationError: Sequelize.ValidationError };