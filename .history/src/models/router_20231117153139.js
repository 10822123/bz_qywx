...
router.belongsToMany(router_api, { as: 'Apis', through: router_bind_api, foreignKey: 'router_id' });
router_api.belongsToMany(router, { as: 'Routers', through: router_bind_api, foreignKey: 'api_id' });
