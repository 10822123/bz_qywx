...
const {generateToken, refreshMiddleware, authMiddleware,checkPermission} = require('./middlewares/jwtauth');
...
app.get('/api/user',  (req, res) => {
  ...
  res.json({ message: 'Protected route, token required', user: req.auth });
