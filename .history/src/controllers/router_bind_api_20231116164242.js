...
module.exports.do_authorize_api = async (req, res, next) => {
  ...
  try {
    ...
    console.log('api_id:', JSON.stringify(api_id,null,2));
    // 查询现有记录
    ...
    console.log('existingRecords:', JSON.stringify(existingRecords,null,2));
    console.log('existingRouterApiPairs:', JSON.stringify(existingRouterApiPairs,null,2));
