...
module.exports.get_list = async (req, res, next) => {
  ...
  try {
    ...
    router.hasMany(router_bind_api, { foreignKey: 'router_id' });
    router_bind_api.belongsTo(router, { foreignKey: 'router_id' });
    
    router_api.hasMany(router_bind_api, { foreignKey: 'api_id' });
    router_bind_api.belongsTo(router_api, { foreignKey: 'api_id' });
