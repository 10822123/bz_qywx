...
const account_phone2 = body('username').isMobilePhone('zh_CN', { strictMode: true }).withMessage('用户名长度必须在3到20个字符之间')
const password2 = body('username').isLength({ min: 6, max: 20 }).withMessage('用户名长度必须在3到20个字符之间')
