...
router.get('/routerv/getList',require('../controllers/routerv').router_list)

router.get('/routerv/get_list',require('../controllers/routerv').get_list)
router.get('/routerv/get_list_tree',require('../controllers/routerv').get_list_tree)
router.post('/routerv/do_edit', require('../schema/routerv').vedit, require('../controllers/routerv').do_edit)
router.post('/routerv/do_delete', require('../schema/routerv').vdel, require('../controllers/routerv').do_delete)
